...
if (isset($_POST['submit'])) {
    ...
    // conditions to validate input values, the different error messages is store them in the session super variable and display above the form in add-user page
    if (!$firstname) {
        ...
        if ($createpassword !== $confirmpassword) {
            ...
            if (mysqli_num_rows($user_check_result) > 0) {
                ...
                $allowed_files = ['png', 'jpg', 'jpeg'];// different image extensions
