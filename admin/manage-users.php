                ...
                <table>
                    ...
                    <tbody>
                        <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                            <tr>
                                <td><?= "{$user['firstname']} {$user['lastname']}" // display the user's first name?></td>
                                <td><?= $user['username'] //display the username from the database ?></td>
                                <td><a href="<?= ROOT_URL ?>admin/edit-user.php?id=<?= $user['id'] //redirect to the edit user page?>" class="btn sm">Edit</a></td>
                                <td><a href="<?= ROOT_URL ?>admin/delete-user.php?id=<?= $user['id'] //redirect to the delete-user page ?>" class="btn sm danger">Delete</a></td>
                                <td><?= $user['is_admin'] ? 'Yes' : 'No'  // displays if the user is an admin or not?></td>
                            </tr>
                        <?php endwhile ?>
                    </tbody>
                </table>
